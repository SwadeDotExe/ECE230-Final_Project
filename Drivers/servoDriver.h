...
#define SERVO_TMR_PERIOD                50000        // ticks for 40Hz signal
#define SERVO_MIN_ANGLE                 1500         // ticks for 0.75ms pulse
#define SERVO_MAX_ANGLE                 4500         // ticks for 2.25ms pulse
#define TEN_DEGREE_TICKS                167          // ticks 10 degree shift
 ...
 * \return None
 */
extern void setServoAngle(uint16_t angle);
