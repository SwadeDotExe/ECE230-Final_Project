...
// Set initial step timer period for 10 RPM (based on 2MHz clock rate)
#define INIT_PERIOD                     5859      // 10 RPM
#define MIN_PERIOD                      58594     // 1  RPM
...
/*!
 * \brief This sets the speed of the motor
 *
 * Sets the speed of the motor from 0-65535
 *
 * Modified bit 4, 5, 6, and 7 of \b P2OUT register.
 *
 * \return None
